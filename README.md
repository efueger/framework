...
##Console Applications
A simple console application can be created by passing the command line arguments to the [`ServiceManager`](https://github.com/mvc5/framework/blob/master/src/Service/Manager/ServiceManager.php) `call` method. E.g
```php
